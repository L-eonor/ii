        ...
        try(DatagramSocket serverSocket = new DatagramSocket(port)){
            ...
            while (true){
                ...
                if(datagramPacket.getData()!=null) {
                    FileWriter file = new FileWriter("C:\\Users\\cjoao\\Desktop\\Projeto II\\ii\\src\\mes\\received_data.xml");
                    ...
                    out.println(line);
                    out.flush();
                    ReadXML("C:\\Users\\cjoao\\Desktop\\Projeto II\\ii\\src\\mes\\received_data.xml");
                    out.close();
                    file.close();
                }
